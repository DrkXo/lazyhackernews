...
mixin _$LazyHackerNewsState {
 ...
 List<Story> get stories; int get selectedIndex; FeedType get category; bool get isLoading; bool get isLoadingMore; bool get hasMore; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(stories),selectedIndex,category,isLoading,isLoadingMore,hasMore,error);

@override
String toString() {
  return 'LazyHackerNewsState(stories: $stories, selectedIndex: $selectedIndex, category: $category, isLoading: $isLoading, isLoadingMore: $isLoadingMore, hasMore: $hasMore, error: $error)';
}
...
@useResult
$Res call({
 List<Story> stories, int selectedIndex, FeedType category, bool isLoading, bool isLoadingMore, bool hasMore, String? error
});
...
/// Create a copy of LazyHackerNewsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? stories = null,Object? selectedIndex = null,Object? category = null,Object? isLoading = null,Object? isLoadingMore = null,Object? hasMore = null,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Story> stories,  int selectedIndex,  FeedType category,  bool isLoading,  bool isLoadingMore,  bool hasMore,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LazyHackerNewsState() when $default != null:
return $default(_that.stories,_that.selectedIndex,_that.category,_that.isLoading,_that.isLoadingMore,_that.hasMore,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Story> stories,  int selectedIndex,  FeedType category,  bool isLoading,  bool isLoadingMore,  bool hasMore,  String? error)  $default,) {final _that = this;
switch (_that) {
case _LazyHackerNewsState():
return $default(_that.stories,_that.selectedIndex,_that.category,_that.isLoading,_that.isLoadingMore,_that.hasMore,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Story> stories,  int selectedIndex,  FeedType category,  bool isLoading,  bool isLoadingMore,  bool hasMore,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _LazyHackerNewsState() when $default != null:
return $default(_that.stories,_that.selectedIndex,_that.category,_that.isLoading,_that.isLoadingMore,_that.hasMore,_that.error);case _:
  return null;
...
class _LazyHackerNewsState implements LazyHackerNewsState {
  const _LazyHackerNewsState({ List<Story> stories = const [], this.selectedIndex = 0, this.category = FeedType.top, this.isLoading = false, this.isLoadingMore = false, this.hasMore = true, this.error}): _stories = stories;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_stories),selectedIndex,category,isLoading,isLoadingMore,hasMore,error);
...
/// Create a copy of LazyHackerNewsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? stories = null,Object? selectedIndex = null,Object? category = null,Object? isLoading = null,Object? isLoadingMore = null,Object? hasMore = null,Object? error = freezed,}) {

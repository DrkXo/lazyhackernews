...
mixin _$LazyHackerNewsState {
 ...
 List<Story> get stories; int get selectedIndex; FeedType get category; bool get isLoading; List<Comment> get comments; bool get isLoadingComments; String? get error;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LazyHackerNewsState&&const DeepCollectionEquality().equals(other.stories, stories)&&(identical(other.selectedIndex, selectedIndex) || other.selectedIndex == selectedIndex)&&(identical(other.category, category) || other.category == category)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&const DeepCollectionEquality().equals(other.comments, comments)&&(identical(other.isLoadingComments, isLoadingComments) || other.isLoadingComments == isLoadingComments)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(stories),selectedIndex,category,isLoading,const DeepCollectionEquality().hash(comments),isLoadingComments,error);

@override
String toString() {
  return 'LazyHackerNewsState(stories: $stories, selectedIndex: $selectedIndex, category: $category, isLoading: $isLoading, comments: $comments, isLoadingComments: $isLoadingComments, error: $error)';
}
...
@useResult
$Res call({
 List<Story> stories, int selectedIndex, FeedType category, bool isLoading, List<Comment> comments, bool isLoadingComments, String? error
});
...
/// Create a copy of LazyHackerNewsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? stories = null,Object? selectedIndex = null,Object? category = null,Object? isLoading = null,Object? comments = null,Object? isLoadingComments = null,Object? error = freezed,}) {
...
as List<Comment>,isLoadingComments: null == isLoadingComments ? _self.isLoadingComments : isLoadingComments // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Story> stories,  int selectedIndex,  FeedType category,  bool isLoading,  List<Comment> comments,  bool isLoadingComments,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LazyHackerNewsState() when $default != null:
return $default(_that.stories,_that.selectedIndex,_that.category,_that.isLoading,_that.comments,_that.isLoadingComments,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Story> stories,  int selectedIndex,  FeedType category,  bool isLoading,  List<Comment> comments,  bool isLoadingComments,  String? error)  $default,) {final _that = this;
switch (_that) {
case _LazyHackerNewsState():
return $default(_that.stories,_that.selectedIndex,_that.category,_that.isLoading,_that.comments,_that.isLoadingComments,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Story> stories,  int selectedIndex,  FeedType category,  bool isLoading,  List<Comment> comments,  bool isLoadingComments,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _LazyHackerNewsState() when $default != null:
return $default(_that.stories,_that.selectedIndex,_that.category,_that.isLoading,_that.comments,_that.isLoadingComments,_that.error);case _:
  return null;
...
class _LazyHackerNewsState implements LazyHackerNewsState {
  const _LazyHackerNewsState({ List<Story> stories = const [], this.selectedIndex = 0, this.category = FeedType.top, this.isLoading = false,  List<Comment> comments = const [], this.isLoadingComments = false, this.error}): _stories = stories,_comments = comments;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LazyHackerNewsState&&const DeepCollectionEquality().equals(other._stories, _stories)&&(identical(other.selectedIndex, selectedIndex) || other.selectedIndex == selectedIndex)&&(identical(other.category, category) || other.category == category)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&const DeepCollectionEquality().equals(other._comments, _comments)&&(identical(other.isLoadingComments, isLoadingComments) || other.isLoadingComments == isLoadingComments)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_stories),selectedIndex,category,isLoading,const DeepCollectionEquality().hash(_comments),isLoadingComments,error);
...
/// Create a copy of LazyHackerNewsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? stories = null,Object? selectedIndex = null,Object? category = null,Object? isLoading = null,Object? comments = null,Object? isLoadingComments = null,Object? error = freezed,}) {
